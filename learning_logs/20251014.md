...
이상의 컴포넌트는 정적 메시지를 렌더링할 뿐이며 재사용할 수 없음. 하드 코딩된 이름을 이용하는 대신에 props를 이용하게 되면 Hello 컴포넌트에 이름을 전달할 수 있다.
...
으로 작성할 수 있다. 그럼 firstName이랑 lastName 두 개 밖에 properties가 없는데 뭐하러 이렇게 쓰냐고 할 수 있는데
